                    ...
                    @foreach ($users as $usuario)
                        <tr>
                            ...
                            @foreach ($usuario->roles as $role)
                                <td class="text-center">{{ $role->nome }}</td>
                            @endforeach
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row justify-content-center mt-2">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input class="form-control @error('cpf') is-invalid @enderror cpf" id="cpf"
                                ...
                                <div class="row justify-content-center mt-2">
                                    <div class="col-sm-6">
                                        ...
                                        <input class="form-control @error('email') is-invalid @enderror" id="email"
                                            type="email" name="email" value={{ $usuario->contato->email ?? '' }}
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input class="form-control @error('telefone') is-invalid @enderror telefone"
                                            id="telefone" type="text" name="telefone" value="{{ old('telefone') }}"
                                ...
                                <div class="row justify-content-center mt-2">
                                    <div class="col-sm-6">
                                        ...
                                        <input class="form-control @error('cep') is-invalid @enderror cep" id="cep"
                                ...
                                <div class="row justify-content-center mt-2">
                                    <div class="col-sm-6">
                                        ...
                                        <input class="form-control @error('rua') is-invalid @enderror" id="rua"
                                            type="text" name="rua" value="{{ old('rua') }}" required
                                            autocomplete="rua" autofocus>
                                        @error('rua')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input class="form-control @error('numero') is-invalid @enderror" id="numero"
                                            type="number" name="numero" value="{{ old('numero') }}" required
                            ...
                            <form method="POST" action="{{ route('usuario.update') }}">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row justify-content-center mt-2">
                                        <div class="col-sm-4">
                                            <label for="name">Nome:</label>
                                            <input class="form-control @error('nome') is-invalid @enderror name"
                                                id="nome" type="text" name="name"
                                                value="{{ $usuario->name }}" required autocomplete="nome" autofocus>
                                            @error('nome')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <input class="form-control @error('cpf') is-invalid @enderror cpf"
                                                ...
                                                value="{{ $usuario->cpf }}" required autocomplete="cpf" autofocus>
                                            @error('cpf')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="row justify-content-center mt-2">
                                        <div class="col-sm-6">
                                            ...
                                            <input class="form-control @error('email') is-invalid @enderror"
                                                ...
                                                value={{ $usuario->contato->email ?? '' }} required autocomplete="email"
                                                autofocus>
                                            @error('email')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-sm-6">
                                            <label for="telefone">Telefone:</label>
                                            <input class="form-control @error('telefone') is-invalid @enderror telefone"
                                                id="telefone" type="text" name="telefone"
                                                value={{ $usuario->contato->telefone ?? '' }} required
                                    ...
                                    <div class="row justify-content-center mt-2">
                                        <div class="col-sm-6">
                                            ...
                                            <input class="form-control @error('cep') is-invalid @enderror cep"
                                                ...
                                                value="{{ $usuario->endereco->cep ?? '' }}" required autocomplete="cep"
                                                autofocus>
                                            @error('cep')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                    ...
                                    <div class="row justify-content-center mt-2">
                                        <div class="col-sm-6">
                                            ...
                                            <input class="form-control @error('rua') is-invalid @enderror" id="rua"
                                                type="text" name="rua"
                                                value="{{ $usuario->endereco->rua ?? '' }}" required autocomplete="rua"
                                                autofocus>
                                            @error('rua')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input class="form-control @error('numero') is-invalid @enderror"
                                                ...
                                                value="{{ $usuario->endereco->numero ?? '' }}" required
                                                autocomplete="numero" autofocus>
                                            @error('numero')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
