...
@section('content')
    <div class="row my-5">
        ...
        <div class="col-sm-8 shadow-lg p-3 bg-white rounded" style="min-height: 28rem">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <button class="btn btn-group" type="button" data-toggle="modal"
                                    data-target="#editModal_{{ $ocs->id }}"><i
                    ...
                    <div class="modal-content">
                        ...
                        <form method="POST" action="{{ route('ocs.store') }}">
                            ...
                            <div class="modal-body">
                                ...
                                <input type="hidden" name="associacao_id" value="{{ $associacao_id }}">
                                <div class="row justify-content-center mt-2">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input class="form-control @error('cnpj') is-invalid @enderror cnpj" id="cnpj"
                                            name="cnpj" value="{{ old('cnpj') }}" required autocomplete="cnpj"
                                            autofocus>
                                        @error('cnpj')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="row justify-content-center mt-2">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="date"
                                            ...
                                            id="data_fundacao" name="data_fundacao" value="{{ old('data_fundacao') }}"
                                            required autocomplete="data_fundacao" autofocus>
                                        @error('data_fundacao')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
            ...
            @foreach ($lista_ocs as $ocs)
                <div class="modal fade" id="editModal_{{ $ocs->id }}" tabindex="-1" role="dialog"
                            ...
                            <form action="{{ route('ocs.update', ['id' => $ocs->id]) }}" method="POST">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row justify-content-center mt-2">
                                        ...
                                        <div class="col-sm-6">
                                            <label for="cnpj">CNPJ:</label>
                                            <input class="form-control @error('cnpj') is-invalid @enderror cnpj"
                                                id="cnpj" name="cnpj" value="{{ $ocs->cnpj }}" required
                                    ...
                                    <div class="row justify-content-center mt-2">
                                        <div class="col-sm-6">
                                            ...
                                            <input type="date"
                                                class="form-control @error('data_fundacao') is-invalid @enderror"
                                                id="data_fundacao" name="data_fundacao"
                                                value="{{ $ocs->data_fundacao }}" required autocomplete="data_fundacao"
                                                autofocus>
                                            @error('data_fundacao')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
